...
import { MyLatestTransaction } from "./MyLatestTransactions";
...
export default async function BanAccountDashboardPage({
  params,
  searchParams,
}: {
  ...
  return (
    <Grid2 container spacing={2}>
      ...
      <Grid2 xs={12}>
        ...
        <MyLatestTransaction transactions={transactions} />
      </Grid2>
    </Grid2>
  );
}
